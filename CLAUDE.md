# [REDACTED] — operações no host

Repo de apoio pra gerenciar o sistema operacional do operador (`[REDACTED]`, `[REDACTED]`/Wayland, fish): buscar informação, modificar config, escrever guias de como modificar.
...
- **Host**: `[REDACTED]` (Arch-based), `[REDACTED]`, systemd
- **Shell**: fish 4.7.1 — **shell de operação obrigatório neste repo**
- **DE**: `[REDACTED]` sobre Wayland (compositor `[REDACTED]`)
